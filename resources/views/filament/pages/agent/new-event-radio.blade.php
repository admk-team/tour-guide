    ...
    <div class="col-span-1 flex-1 w-full block p-4 rounded border mb-6 shadow">
        <div class="flex gap-3 items-center">
            ...
            @if($tourguide->doesntBookedFromAgent(auth('agent')->id(), $event['id']))
                @if(!$tourguide->hasOverlappingAppointments($event['start_at'], $event['start_at']) || !$tourguide->hasOverlappingAppointments($event['start_at'], $event['end_at']))
                ...
                @else
                <div class="col-span-1 flex-1 w-full text-red-500">
                                        <div class="filament-tables-column-wrapper">
                        <div class="flex w-full justify-start text-start">
                            <div
                                class="inline-flex items-center space-x-1 rtl:space-x-reverse">
                                <div class="bg-danger-500 text-white px-3 py-2 rounded-full text-sm">
                                    Tour guide is not available at this time.
                                </div>
                            </div>
                        </div>
                    </div>
