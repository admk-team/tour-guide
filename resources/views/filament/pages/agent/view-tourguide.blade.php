<x-filament::page>
    <section class="bg-white">
                    ...
                    <div class="flex flex-col md:flex-row items-center col-span-3">
                        <div class="flex flex-col space-y-3 w-full">
                            ...
                            <div class="flex flex-row space-x-5">
                                ...
                                <p class="font-semibold text-gray-500 dark:text-gray-400">{{ $record->country?->name . ', ' . $record->city?->name }}</p>
                            </div>
                            <div class="flex flex-row space-x-5">
                                <p class="text-gray-500 dark:text-gray-400">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
        ...
        <section class="grid grid-cols-1 lg:grid-cols-4 gap-4 md:gap-10 items-center p-4 mt-4">
                        ...
                        <div class="flex flex-col space-y-2">
                            @foreach ($record->skills as $skill)
                                <div class="flex flex-row space-x-2">
                                    ...
                                    <p class="text-gray-500 text-sm dark:text-gray-400">({{ $skill->pivot->level }})</p>
                                </div>
                            @endforeach
                        </div>
                    </div>
            ...
            <div class="col-span-3">
                <div class="mb-4 border-b border-gray-200 dark:border-gray-700">
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center mb-4 border-b border-gray-200 dark:border-gray-700" id="myTab"
                    ...
                    <section class="mb-5">
                            <div class="mt-4">
                                    <div class="mt-3 space-x-3">
                                        <p class="px-6 text-left py-4 font-normal text-sm text-gray-700 dark:text-gray-400">
                                            {{ $record-> bio ?? 'There\'s no biography available' }}</p>
                                    </div>
                            </div>
                        </section>
                            ...
                            <div class="mt-4">
                                        ...
                                        @if ($record->phones->isNotEmpty())
                                            @foreach ($record->phones as $phone)
                                                <label for="{{ $phone->type }}"
                                                    class="inline text-sm font-medium text-gray-700" style="text-transform:capitalize">{{ $phone->type }} :</label>
                                                <a href="tel:{{ $phone->number }}" class="inline mt-1 text-sm text-blue-400">
                                                    {{ $phone->number }}
                                                </a>
                                            @endforeach
                                        @else
                                            <p class="mt-1 text-sm text-blue-400">{{ __('No phone numbers available.') }}</p>
                                        @endif
                                    </div>
                                <div class="mt-3 space-x-5">
                                    <label for="email"
                                        ...
                                        :</label>
                                    <a href="mailto:{{ $record->email }}" class="inline mt-1 text-sm text-sky-400">{{ $record->email }}</a>
