    ...
    @if(auth('agent')->check() && $user)
        <div
            ...
            <div
                ...
                <div class="relative flex items-center space-x-4 ml-5" style="width:100%">
                    ...
                    @php $receiver = $current_room->members()->whereMemberableType(\App\Models\Tourguide::class)->first()->memberable; @endphp
                        ...
                        <div class="flex-grow"></div>
                            <div class="relative flex items-center space-x-4 ml-5">
                                <div class="relative">
                                    <span class="absolute right-0 bottom-0 @if($receiver->is_online) text-success-500 @else text-danger-500 @endif">
                                        <svg width=" 20" height="20">
                                            <circle cx="15" cy="12" r="5" fill="currentColor"></circle>
                                        </svg>
                                    </span>
                                        <img src="{{ $receiver->avatar }}" alt="{{ $receiver->full_name }}" class="w-10 lg:w-11 h-10 lg:h-11 rounded-full">
                                </div>
                                <div class="flex flex-col leading-tight">
                                    <div class="text-lg mt-1 flex items-center">
