...
<main role="main">
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        <ol class="carousel-indicators">
            @forelse($slider->contents()->where('name->' . app()->getLocale(), 'slider_hero')->first()->hero_slider as $key => $image)
                <li data-target="#myCarousel" data-slide-to="{{ $key }}" class="{{ $key === 0 ? 'active' : '' }}"></li>
            @empty
                <!-- Handle the case when hero_slider is empty -->
            @endforelse
        </ol>
...
<!--                    @forelse($slider->contents()->where('name->' . app()->getLocale(), 'slider_hero')->first()->hero_slider as $key => $title)-->
    <!-- Display each title here -->
<!--    {{ $slider->contents()->firstWhere('name->' . app()->getLocale(), 'slider_hero')->title }}-->
    <!--{{ $title }}-->
<!--@empty-->
    <!-- Handle the case where there are no 'slider_hero' titles -->
<!--@endforelse-->
                ...
                @endif
                            <!-- You can add dynamic content related to this slide using $key or $image here -->
                            <!-- <h1>Example headline {{ $key + 1 }}</h1> -->
            ...
            @forelse($slider->contents()->where('name->' . app()->getLocale(), 'slider_hero')->first()->hero_slider as $key => $image)
                <div class="carousel-item {{ $key === 0 ? 'active' : '' }}">
                    <img class="slide-image" src="{{ $image }}" alt="Slide {{ $key + 1 }}">
                </div>
            @empty
                <!-- Code for default slides when hero_slider is empty -->
            @endforelse
        </div>
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img class="second-slide" src="{{ asset('images/abouts-1.jpeg') }}" alt="Second slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="third-slide" src="{{ asset('images/abouts-2.jpeg') }}" alt="Third slide">
            <div class="container">
...
@push('styles')
<link href="https://guidesnavigator.com/css/bootstrap.min2.css?v=0.44" rel="stylesheet">
<link href="https://guidesnavigator.com/css/carousel2.css?v=0.44" rel="stylesheet">
@endpush

@push('scripts')
<script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>
<script src="https://guidesnavigator.com/css/bootstrap.min.js"></script>
@endpush
