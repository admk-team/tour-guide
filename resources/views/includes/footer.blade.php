...
<link href="{{ asset('css/footer.css') }}?v=123456789" rel="stylesheet">
{{-- Subscribe Section --}}
...
{{-- Sponsors --}}
<section id="sponsors" class="bg-dark-2 py-10">
    <div class="container mx-auto px-32">
        <div class="sponsors grid lg:grid-cols-6 md:grid-cols-4 grid-cols-1 gap-2">
...
@endif
            ...
            <div class="col-span-1">
                ...
                <div class="flex items-center">
                    ...
                    <a href="{{ $footer?->contents()->firstWhere('name->' . app()->getLocale(), 'footer_download_our_app_google_play_link')?->content }}" target="_blank">
