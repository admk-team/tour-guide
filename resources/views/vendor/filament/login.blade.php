<form wire:submit.prevent="authenticate" class="space-y-8">
    ...
    @if(!\Route::is('filament.auth.login'))
        <div class="w-full flex justify-center">
                ...
                @style(['background-color: rgb(107 114 128 / var(--tw-bg-opacity)); color: white; border: 1px solid rgb(107 114 128 / var(--tw-bg-opacity)); hover:background-color: #3b82f6; hover:border: 1px solid #3b82f6;'])>
...
<?php /*?> <x-filament::button type="submit" form="authenticate" class="w-1/2"
                @style(['background-color: #3B86FF; color: white; border: 1px solid #3b82f6; hover:background-color: #3b82f6; hover:border: 1px solid #3b82f6;'])> <?php */?>