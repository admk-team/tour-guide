                ...
                ->schema([
                    Select::make('name')
                        ...
                        ->options([
                            ...
                            'slider_ourservice' => 'Our Program Section',
                        ]),
...
//                        ->required()
        ...
        //             ->label(__('attributes.landing_page.contents'))
        //             ->minItems(1)
        //             ->maxItems(10) // Adjust the maximum number of slides as per your requirement
        //             ->schema([
        //                 Select::make('name')
        //                     ->label(__('attributes.landing_page.name'))
        //                     ->required()
        ...
        //                 Repeater::make('slide_contents') // Nested repeater for multiple sets of content
        //                     ->label(__('Slide Contents'))
        //                     ->minItems(1) // Minimum number of content sets per slide
        //                     ->maxItems(10) // Maximum number of content sets per slide
        //                     ->schema([
        //                         TextInput::make('title')
        //                             ->label(__('attributes.landing_page.title'))
        //                             ->required()
